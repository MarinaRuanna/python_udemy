...
Herança Mútipla nad amais é do que a possibilidade de uma classe herdar de mútiplas classes, fazendo com que a
...
'''
A ordem da herançã irá alterar o comportamento do objeto
'''
