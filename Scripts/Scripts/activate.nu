...
let virtual-env = "C:\Users\Miguel\Envs\ProjetosPyMarina"
let bin = "Scripts"
let path-sep = ";"
...
let virtual_prompt = (if ("(ProjetosPyMarina) " != "") {
    "((ProjetosPyMarina) ) "
} {
...
alias deactivate = source "C:\Users\Miguel\Envs\ProjetosPyMarina\Scripts\deactivate.nu"
